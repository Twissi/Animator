...
public enum PredefinedAnimation {
	ARROW('A', "Arrow", new int[] { 0x14, 0x2A, 0x49, 0x49, 0x3E, // frame 1
			...
			}), FIRE('B', "Fire", new int[] { 0x78, 0x5C, 0x68, 0x78, 0x71, // frame
																			// 1
	...
	}), BOUNCE('C', "Bounce", new int[] { 0x01, 0x00, 0x00, 0x00, 0x00, // frame
																		// 1
	...
	}), MOUNTAINRANGE('D', "Mountain Range", new int[] { 0x08, 0x44, 0x28,
			0x10, 0x08, // frame 1
			0x04, 0x02, 0x04, 0x08, 0x50, // frame 2
			0x30, 0x10, 0x08, 0x04, 0x04, // frame 3
			0x02, 0x01, // frame 4
	}), SNOW('E', "Snow", new int[] { 0x01, 0x00, 0x00, 0x00, 0x00, // frame 1
	...
	}), TUNNEL('F', "Tunnel", new int[] { 0x00, 0x00, 0x1C, 0x00, 0x00, // frame
																		// 1
			0x00, 0x3E, 0x22, 0x3E, 0x00, // frame 2
			0x7F, 0x41, 0x41, 0x41, 0x7F, // frame 3
	}), WINK('G', "Wink", new int[] { 0x00, 0x26, 0x20, 0x26, 0x00, // frame 1
	...
	}), ECG('H', "ECG", new int[] { 0x10, 0x10, 0x10, 0x10, 0x10, // frame 1
			0x08, 0x10, 0x10, 0x0F, 0x70, // frame 2
			0x10, 0x10, 0x08, 0x08, 0x10, // frame 3
			0x10, 0x10, 0x10, 0x10, 0x10, // frame 4
	}), CHECKERS('I', "Checkers", new int[] { 0x55, 0x2A, 0x55, 0x2A, 0x55, // frame
																			// 1
			0x2A, 0x55, 0x2A, 0x55, 0x2A, // frame 2
	}), TETRIS('J', "Tetris", new int[] { 0x00, 0x00, 0x07, 0x00, 0x00, // frame
																		// 1
	...
	}), GLIDER('K', "Glider", new int[] { 0x03, 0x00, 0x00, 0x00, 0x00, // frame
																		// 1
	...
	}), HOP('L', "Hop", new int[] { 0x20, 0x50, 0x50, 0x20, 0x00, // frame 1
			0x30, 0x48, 0x48, 0x30, 0x00, // frame 2
			0x06, 0x09, 0x09, 0x06, 0x00, // frame 3
			0x01, 0x02, 0x02, 0x01, 0x00, // frame 4
			0x00, 0x01, 0x01, 0x00, 0x00, // frame 5
	}), PONG('M', "Pong", new int[] { 0x40, 0x40, 0x09, 0x01, 0x00, // frame 1
	...
	}), HOUSE('N', "House", new int[] { 0x40, 0x40, 0x40, 0x40, 0x40, // frame 1
	...
	}), ROCKET('O', "Rocket", new int[] { 0x40, 0x3C, 0x43, 0x3C, 0x40, // frame
																		// 1
	...
	}), TRAIN('P', "Train", new int[] { 0x3F, 0x67, 0x64, 0x24, 0x66, // frame 1
	...
	}), EXPLODE('Q', "Explode", new int[] { 0x00, 0x02, 0x7D, 0x00, 0x00, // frame
																			// 1
	...
	}), DROPLET('R', "Droplet", new int[] { 0x40, 0x40, 0x41, 0x40, 0x40, // frame
																			// 1
	...
	}), PSYCHO('S', "Psycho", new int[] { 0x1C, 0x3E, 0x77, 0x3E, 0x1C, // frame
																		// 1
	...
	}), TV_OFF('T', "TV off", new int[] { 0x7F, 0x7F, 0x7F, 0x7F, 0x7F, // frame
																		// 1
	...
	}), CLOCK('U', "Clock", new int[] { 0x1C, 0x22, 0x2E, 0x2A, 0x1C, // frame 1
